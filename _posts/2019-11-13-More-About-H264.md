...
1. 调用 `H264::ParseRbsp` 函数去掉码流中对起始码（`001` 或 `0001`）的转义处理，关于起始码转义，可以阅读我的[我需要知道：H.264](/2017/09/22/I-Need-Know-About-H264/index.html#%E5%8A%9F%E8%83%BD%E5%88%86%E5%B1%82) 这篇文章；
