...
国内公司面试的问题分为算法和安卓两类，安卓相关的问题，基本都在我后来整理的[安卓基础系列博客](/tags/index.html#基础知识)中，算法相关的我将在后面结合国外面试展开讲。国外公司的面试问题，基本都是算法，Google 尤甚，Facebook 会问一点点安卓相关的问题，但也以算法为主。
...
至于安卓开发领域的具体知识点，可以参考键盘男引用的 Android App 开发技能图谱，也可以参考我的[安卓基础系列博客](/tags/index.html#基础知识)。
